...
output "edo_db_instance_address" {
  value = aws_db_instance.edo_rds01.address
  description = "edo db intance address"
}

output "edo_db_instance_port" {
  value = aws_db_instance.edo_rds01.port
  description = "edo db instance port"
}

output "db_secret_arn" {
  value = aws_secretsmanager_secret.edo_db_secret01.arn
}

output "db_secret_name" {
  value = aws_secretsmanager_secret.edo_db_secret01.name
}
...
output "edo_cw_log_group_arn" {
  value = aws_cloudwatch_log_group.edo_log_group01.arn
}
